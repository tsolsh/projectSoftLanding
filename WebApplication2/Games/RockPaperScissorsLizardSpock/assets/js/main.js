...
let winState = { '"rock"': ['"scissors"','"lizard"'], '"paper"': ['"rock"','"spock"'], '"scissors"': ['"paper"','"lizard"'], '"spock"': ['"scissors"','"rock"'], '"lizard"': ['"spock"','"paper"']};
...
function battle(option) {
	$(".game").animate({maxWidth:'620px'},2000);
	$(".selected").animate({width:'130px',
						  height:'130px'
						  },2000);
	...
	if (choice === aiChoice) {
		...
		winningStreak = 0;
    } else if (aiChoice === winState[choice][0] || aiChoice === winState[choice][1]) {
...
function initLevels() {
	...
	if (level == 1) {
		...
		let operations = document.getElementById("operations");
		operations.value = "\n\nEXPLANATION\nYour opponent hasn't Given up!, he is challenging you again but this time the 'Lizard' and 'Spock' choices are added!\n\nTASK\n-Uncover your opponent's move by using the peek function.\n-Determine your Winning-Move by using the power of the 'Switch - case' statements!\n\nGOAL\n-BEAT your opponent 3 times in a row!\n\n\n\n\n GOOD LUCK!";
	//let operations = document.getElementById("operations");
	//	operations.value = "\n\n\ntry to beat your rival, best of 3, instead of clicking on the buttons, you must write code to pick your choice...you have a variable and play function. use them wisely.";	
		...
		alert("CONGRATULATIONS!, You completely beat your opponent!");
		let operations = document.getElementById("operations");
		operations.value = "\n\nEXPLANATION\nYour opponent hasn't Given up!, he is challenging you again but this time the 'Lizard' and 'Spock' choices are added!\n\nTASK\n-Uncover your opponent's move by using the peek function.\n-Determine your Winning-Move by using the power of the 'Switch - case' statements!\n\nGOAL\n-BEAT your opponent 3 times in a row!\n\n\n\n\n GOOD LUCK!";	
	}
